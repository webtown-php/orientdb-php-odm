...
use Doctrine\ODM\OrientDB\Tests\Document\Stub\Embedded\EmailAddress;
use Doctrine\ODM\OrientDB\Tests\Document\Stub\Embedded\Phone;
...
class UnitOfWorkChangeSetWithEmbeddedDocumentTest extends TestCase
{
    ...
    public function before() {
        $this->manager         = $this->createDocumentManager([], ['Doctrine/ODM/OrientDB/Tests/Document/Stub/Embedded']);
